...
export default function ProductInfo({ title, description, price, rating, ratingCount, seller, category, stock, colors, dimensions, onAddToCart }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col gap-4 bg-white p-9 rounded-xl shadow-sm border border-slate-200">
      ...
      <div className="flex justify-between">
        ...
        <span className="flex items-center gap-2 text-green-600 text-semibold"><LiaShippingFastSolid size={20} /> Free Shipping! </span>
      </div>
      <div className="flex">
      ...
      <div>
        <p className="flex items-center gap-2 text-slate-800"><FaCheck className="text-green-600" /> Arrives soon! Get it by <span className="font-semibold">{formatDate(min)} – {formatDate(max)}</span> if you order today!
        </p>
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex gap-4">
          ...
          <Image src="/american-express.svg" alt="payment" width={25} height={25} />
          </div>
