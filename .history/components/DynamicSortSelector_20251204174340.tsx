            ...
            {Object.entries(options).map(([value, label]) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex justify-between items-center text-left px-3 py-2 text-sm hover:bg-slate-100 dark:hover:bg-slate-600 transition ${selected === val ? "bg-slate-200 font-medium" : ""}`}
                >
                  {labelString}
