      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-2/  md:w-64 bg-white shadow-lg z-50"
          >
            <div className="p-4 flex justify-between items-center border-b">
              <h2 className="text-lg font-bold">Menu</h2>
              <button onClick={toggleMenu} className="text-slate-900 font-bold text-xl"><X/>
              </button>
            </div>
            ...
            <ul className="p-4 flex flex-col gap-4 px-6">
              ...
              <li><Link href="/about" className="hover:text-blue-500">Shop</Link></li>
              
              <li><Link href="/contact" className="hover:text-blue-500">Contact</Link></li>
              <li><Link href="/dashboard" className="hover:text-blue-500">Blog</Link></li>
            </ul>
          </motion.div>
        )}
      </AnimatePresence>
