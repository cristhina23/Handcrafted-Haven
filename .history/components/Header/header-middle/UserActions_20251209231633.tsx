        ...
        {isMenuOpen && (
          ...
          >
            ...
            <ul className="p-4 flex flex-col gap-4 px-6">
              ...
              <li><Link href="/" className="hover:text-blue-500 text-lg font-bold" onClick={toggleMenu}>Shop</Link></li>
              
              <li><Link href="/contact" className="hover:text-blue-500 text-lg font-bold" onClick={toggleMenu}>Contact</Link></li>
              <li><Link href="/contact" className="hover:text-blue-500 text-lg font-bold" >Contact</Link></li>
              <li><Link href="/dashboard" className="hover:text-blue-500 text-lg font-bold" onClick={toggleMenu}>Blog</Link></li>
            </ul>
            </div>
          </motion.div>
        )}
