...
const Sidebar: FC<SidebarProps> = ({
  ...
  return (
    <div className={`h-screen overflow-y-auto pb-10 bg-white dark:bg-[#1e1e1e] shadow-md transition-all duration-300 ${collapsed ? "w-20" : "w-64"}`}>
            ...
            {section.links.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`${collapsed ? "hidden" : "block"} capitalize`}>
                      {link.name.replace("-", " ")}
                    </span>
                </Link>
              );
