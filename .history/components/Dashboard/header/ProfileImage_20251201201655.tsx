            ...
            <div className="flex items-start justify-between px-4 py-3 border-b border-gray-200">
              ...
              >
                  ...
                  <motion.div  
                    ...
                    <p className="font-semibold text-gray-800 text-sm text-start">Edit Profile</p>
                  </motion.div>
              ...
              >
                  ...
                  <motion.div  
                    className="px-4 py-3 w-full hover:bg-gray-100 border-b border-gray-100 cursor-pointer"                 >
                    <p className="font-semibold text-gray-800 text-sm text-start">My Store</p>
                  </motion.div>
              ...
              >
                  ...
                  <motion.div  
                    className="px-4 py-3 w-full hover:bg-gray-100 border-b border-gray-100 cursor-pointer"                 >
                    <p className="flex items-center gap-2 font-semibold text-gray-800 text-sm text-start"><Settings size /> Settings</p>
                  </motion.div>
