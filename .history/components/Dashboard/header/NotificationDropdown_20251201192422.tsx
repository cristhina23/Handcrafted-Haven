...
export default function NotificationDropdown({ notifications }: Props) {
  ...
  return (
    <div className="flex justify-center items-center rounded-md hover:bg-gray-500 dark:hover:bg-gray-700 text-slate-300" ref={dropdownRef}>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className=" w-80 bg-white border border-gray-300 rounded-md shadow-lg overflow-hidden z-50"
          >
