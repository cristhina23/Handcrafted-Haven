  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className="p-2 rounded-full  hover:bg-gray-500 dark:hover:bg-gray-700 text-slate-300 transition-all"
      >
        <BellIcon className="w- h-5 text-gray-700" />
      </motion.button>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-96 bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden z-50"
          >
            {/* Header */}
