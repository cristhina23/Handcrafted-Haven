    ...
    <div className="flex flex-col bg-white border border-slate-200 dark:border-none dark:bg-slate-800 p-6 rounded-xl shadow-lg md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 text-sm">
        <div className="bg-slate-300 dark:bg-slate-700 p-4 rounded-lg">
          <p className="text-slate-900 dark:bg-slate-300">Current Week</p>
          <h3 className="text-xl font-bold text-slate-900 dark:bg-slate-300">
            ${stats?.weeklyRevenue?.toLocaleString() ?? 0}
          </h3>
        </div>

        <div className="bg-slate-300 dark:bg-slate-700 p-4 rounded-lg">
          <p className="text-slate-900 dark:bg-slate-300">Past Week</p>
          <h3 className="text-xl font-bold text-slate-900 dark:bg-slate-300">
        ...
        <div className="bg-slate-300 dark:bg-slate-700 p-4 rounded-lg">
          <p className="text-slate-900 dark:bg-slate-300">Today’s Earnings</p>
          <h3 className="text-xl font-bold text-slate-900 dark:bg-slate-300">
