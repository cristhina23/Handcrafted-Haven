...
export default function RevenueAnalytics() {
  ...
  return (
    <div className="flex flex-col bg-white border border-slate-200 dark:border dark:bg-slate-800 p-6 rounded-xl shadow-lg md:p-6">
      {/* Header */}
      ...
      <div className="mt-4">
        <IgrCategoryChart
          ...
          /* 👇 Dark Mode Fix */
          xAxisLabelTextColor="#cbd5e1"   /* slate-300 */
          yAxisLabelTextColor="#cbd5e1"
          yAxisTitleTextColor="#cbd5e1"
