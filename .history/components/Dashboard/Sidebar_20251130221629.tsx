...
const Sidebar: FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`h-screen overflow-y-auto pb-10 bg-white dark:bg-[#1e1e1e] shadow-md transition-all duration-300 
      ${collapsed ? "w-20" : "w-64"}`}
    >
      <div className="flex justify-between items-center p-4">
        ...
        <button
          ...
          className="text-xl rounded-full p-2 hover:bg-gray-200 dark:hover:bg-gray-700"
        >
          <X />
        </button>
      </div>
