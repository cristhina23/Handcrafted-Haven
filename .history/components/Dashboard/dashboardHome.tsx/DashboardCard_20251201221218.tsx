...
export default function DashboardCard({
  ...
  return (
    <div className="bg-white border-2 border-slate-300 p-6 rounded-xl shadow-lg border border-white/5 flex flex-col gap-3">
      ...
      {/* Link */}
      <a className="text-blue-400 text-sm mt-2 hover:underline cursor-pointer">
        {link}
      </a>
    </div>
  );
