  ...
  return ( 
    <div className='w-full bg-linear-to-r from-indigo-500 from-10% via-sky-500 via-30% to-purple-500 to-90% p-6 rounded-md flex items-center gap-6'> 
      <Image 
        ...
        <div> <h1 className='text-lg font-bold '>Welcome {user?.firstName}</h1> <p>{seller?.shopName} is ready for another great day of growth.</p> </div> </div> ) } export default WelcomeBanner