...
export default function ProductTable() {
  ...
  // Separación y borde de las celdas
  "& .MuiDataGrid-cell": {
  ...
  // Separación específica para la columna de imágenes
  ...
  "& .MuiDataGrid-columnHeaders": {
    ...
    borderBottom: `2px solid ${isDark ? darkColors.cellBorder : "#e5e5e5"}`,
    fontWeight: 600,
  },

  // Hover
  "& .MuiDataGrid-row:hover": {
    backgroundColor: isDark ? darkColors.hoverBg : "#e5e7eb",
  },

  // Footer
  "& .MuiDataGrid-footerContainer": {
    backgroundColor: isDark ? darkColors.footerBg : "#f5f5f7",
    borderTop: `1px solid ${isDark ? darkColors.cellBorder : "#e5e5e5"}`,
  },
}}
