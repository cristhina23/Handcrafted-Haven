...
export default function ProductTable() {
  ...
  const darkColors = {
  background: "#0f172a",      // Fondo de la tabla
  cellBorder: "#94a3b8",      // Línea entre celdas
  headerBg: "#0f172a",        // Fondo encabezado
  headerText: "#cbd5e1",      // Texto encabezado
  footerBg: "#0f172a",        // Fondo footer
  text: "#cbd5e1",             // Texto general
};
  ...
  border: "none",
  backgroundColor:
    theme.palette.mode === "dark" ? darkColors.background : "#f5f5f7",
  color:
    theme.palette.mode === "dark" ? darkColors.text : "#1f1f2e",
  "& .MuiDataGrid-cell": {
    borderBottom: `1px solid ${
      theme.palette.mode === "dark" ? darkColors.cellBorder : "#e5e5e5"
    }`,
  },
  "& .MuiDataGrid-columnHeaders": {
    backgroundColor:
      theme.palette.mode === "dark" ? darkColors.headerBg : "#f5f5f7",
    color:
      theme.palette.mode === "dark" ? darkColors.headerText : "#1f1f2e",
  },
  "& .MuiDataGrid-footerContainer": {
    backgroundColor:
      theme.palette.mode === "dark" ? darkColors.footerBg : "#f5f5f7",
  },
}}
