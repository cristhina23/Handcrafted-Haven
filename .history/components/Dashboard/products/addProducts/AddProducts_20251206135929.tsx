...
export default function AddProductFormExtended() {
  ...
  return (
    <form className="max-w-3xl mx-auto p-2 md:p-6 bg-white dark:bg-slate-900 rounded-lg text-slate-900 dark:text-slate-300 space-y-4 shadow-2xl " onSubmit={handleSubmit}>
