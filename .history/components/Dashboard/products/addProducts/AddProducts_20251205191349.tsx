...
export default function AddProductFormExtended() {
  ...
  return (
    <form className="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-lg dark:text-slate-300 space-y-4 max-h-full overflow-auto" onSubmit={handleSubmit}>
