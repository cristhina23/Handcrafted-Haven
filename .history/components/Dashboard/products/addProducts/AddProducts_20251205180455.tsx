      ...
      <div>
        ...
        {variants.map((v, i) => (
          <div key={i} className="flex gap-2 mb-2">
            ...
            <Input placeholder="Material" value={v.material} onChange={e => updateVariant(i, "material", e.target.value)} />
      ...
      <div className="space-y-2 border border-dashed p-4 rounded">
        ...
        {mainImage && (
          <div className="flex items-center gap-2 mt-2 relative">
            ...
            <Button type="button" variant="destructive" size="icon" onClick={removeMainImage}>✕</Button>
          </div>
        )}
      </div>
