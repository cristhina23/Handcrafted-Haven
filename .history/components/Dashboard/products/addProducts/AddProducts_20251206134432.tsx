      ...
      <div className="border border-dashed ">
        ...
        <div className="space-y-2 ">
          <div className="relative w-40 h-40">
            <span className="w-40 h-40 border border-dashed rounded flex items-center justify-center cursor-pointer border-slate-400 dark:border-slate-500 hover:bg-slate-200 dark:hover:bg-slate-700 transition">
            {mainImage ? (
              <Image
                width={100}
                height={100}
