...
export default function AddProductFormExtended() {
  ...
  return (
    <form className="max-w-3xl mx-auto p-1 md:p-6 bg-white dark:bg-slate-900 rounded-lg text-slate-900 dark:text-slate-300 space-y-4 max-h-full overflow-auto" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <div className="flex gap-4">
          {["Standard", "Express", "Overnight"].map(method => (
            <div key={method} className="flex flex-col md:flex-row items-center gap-2">
              <Checkbox
      ...
      <Button type="submit" className="w-full bg-slate-900 dark:bg-slate-600">Add Product</Button>
    </form>
  );
}
