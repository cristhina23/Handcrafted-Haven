...
export default function OrdersAccordionTable({ sellerId }: { sellerId: string }) {
  ...
  {item.productId && "image" in item.productId && item.productId.image && (
    <img
  ...
  <span title={item.productId && "title" in item.productId ? item.productId.title : item.productId.$oid}>
    {item.productId && "title" in item.productId
