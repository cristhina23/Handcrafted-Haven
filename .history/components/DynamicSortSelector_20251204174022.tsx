  ...
  return (
    <div className="relative w-full md:w-48" ref={dropdownRef}>
      <motion.button
        ...
        className="flex items-center justify-between w-full px-3 py-2 bg-white dark:bg-[#3b82f6] border border-slate-300 rounded-lg shadow-sm text-slate-700 text-sm"
      >
