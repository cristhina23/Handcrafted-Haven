            ...
            {Object.entries(options).map(([value, label]) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex justify-between items-center text-left px-4 py-2 text-sm hover:bg-slate-100 dark:hover:bg-slate-600 transition ${selected === val ? "bg-slate-200 dark:bg-slate-600 font-medium" : ""}`}
                >
                  {labelString}
