      ...
      >
        ...
        <div>
          ...
          <p className="mt-3 text-white/90">
            At Hancrated, we believe every artisan deserves real opportunities. Together, we can bring your work tocustomers searching for authenticity and products made with heart.
          </p>
        </div>
