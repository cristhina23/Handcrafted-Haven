...
export default function BecomeSeller() {
  return (
    <section className="w-full  py-16 px-6 md:px-12 flex justify-center"
     style={{
    backgroundImage: "url('/public/sellerBanner.jpg')", 
  }}>
      <motion.div
      ...
      >
        <div className="text-center space-y-6">
          ...
          <Link href="/seller/create">
            <Button
              size="lg"
              className="bg-black hover:bg-slate-800 text-white rounded-2xl px-8 py-6 text-lg transition-all"
            >
              Create my shop
            </Button>
          </Link>
