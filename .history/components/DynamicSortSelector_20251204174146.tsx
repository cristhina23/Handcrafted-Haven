  ...
  return (
    <div className="relative w-full md:w-48" ref={dropdownRef}>
      <motion.button
        ...
        className="flex items-center justify-between w-full px-3 py-2 bg-white dark:bg-slate border border-slate-300 dark:border-slate-600 rounded-lg shadow-sm text-slate-700 text-sm dark:text-slate-300"
      >
