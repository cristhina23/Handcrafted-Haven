...
export default function MyStorePage() {
  ...
  return (
    <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border max-w-3xl mx-auto shadow-2xl">
            ...
            <div className="absolute top-0 right-0">
              {localImage ? (
                <button
                  ...
                  className=" text-white w-6 h-6 flex items-center justify-center rounded-md hover:bg-red-600 transition"
                >
                  <X className="size-4" />
                </button>
              ) : (
      ...
      {/* Stats */}
      <div className="mt-6 grid grid-cols-2 gap-6 bg-slate-200 dark:bg-slate-700 p-4 rounded-lg">
        <div>
