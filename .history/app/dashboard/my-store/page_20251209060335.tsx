        ...
        {edit && (
          <div className="absolute top-1 right-1">
            {form.profileImage && form.profileImage !== seller.profileImage ? (
              ...
              <label className="cursor-pointer bg-gray-200 dark:bg-gray-700 p-1 rounded-full hover:bg-gray-300 dark:hover:bg-gray-600 transition flex items-center justify-center">
                ✏️
                <input
                  type="file"
                  accept="image/*"
