...
export default function MyStorePage() {
  ...
  return (
    <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border max-w-3xl mx-auto">
      ...
      {/* PROFILE IMAGE */}
      <div className="flex flex-col items-center justify-center gap-4 mb-6 relative border border-red-500">
        <div className="relative w-34 h-34 rounded-md overflow-hidden  shadow">
          <Image
