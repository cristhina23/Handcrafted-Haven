                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="h-9 w-full rounded-md border border-[#D0D3D8] bg-white px-3 text-sm shadow-xs focus:border-s focus:outline-none focus:ring-2 focus:ring-[#876A5C]/20"
                      >
                        {countryCodes.map((item) => (
