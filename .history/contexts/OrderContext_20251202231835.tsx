...
export const OrderProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <OrderContext.Provider value={{ stats, refreshStats: fetchStats, analytics, refreshAnalytics: fetchAnalytics, revenueByCountry, refreshRevenueByCountry: fetchRevenueByCountry }}>
      {children}
